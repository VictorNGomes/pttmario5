...
#load dataset
    def load_dataset_hugging_face(self, dataset="VictorNGomes/CorpusTeMario", token=None):
        ...
        print("\nText:")
        print(dataset_samsum["test"][0]["texto"])
        print("\nSummary:")
        print(dataset_samsum["test"][0]["sumario"])
    ...
    def convert_examples_to_features(self,example_batch):
        ...
        inputs = [prefix + doc for doc in example_batch['texto']]
...
def main():
    ...
    model = Model()
    dataset = model.load_dataset_hugging_face()
    ...
    with mlflow.start_run():
        ...
        dataset['test'], rouge_metric, trainer.model, model.t5_tokenizer, batch_size = 1, column_text = 'texto', column_summary= 'sumario'
    )
